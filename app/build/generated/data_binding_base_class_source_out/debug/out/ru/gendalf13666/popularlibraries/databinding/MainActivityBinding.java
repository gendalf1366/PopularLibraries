...
public final class MainActivityBinding implements ViewBinding {
  ...
  private MainActivityBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout container) {
  ...
  public static MainActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MainActivityBinding((ConstraintLayout) rootView, container);
    }
