...
public final class UserFragment_MembersInjector implements MembersInjector<UserFragment> {
  ...
  public static MembersInjector<UserFragment> create(
      ...
      Provider<GithubUsersRepository> githubUsersRepositoryProvider,
      Provider<UserAvatarRepository> userAvatarRepositoryProvider) {
    return new UserFragment_MembersInjector(androidInjectorProvider, routerProvider, appSchedulersProvider, githubUsersRepositoryProvider, userAvatarRepositoryProvider);
  }
  ...
  @InjectedFieldSignature("ru.gendalf13666.popularlibraries.baselogic.user.UserFragment.router")
  public static void injectRouter(UserFragment instance, Router router) {
    instance.router = router;
  }

  @InjectedFieldSignature("ru.gendalf13666.popularlibraries.baselogic.user.UserFragment.appSchedulers")
  public static void injectAppSchedulers(UserFragment instance, AppSchedulers appSchedulers) {
    instance.appSchedulers = appSchedulers;
  }

  @InjectedFieldSignature("ru.gendalf13666.popularlibraries.baselogic.user.UserFragment.githubUsersRepository")
  public static void injectGithubUsersRepository(UserFragment instance,
      GithubUsersRepository githubUsersRepository) {
    instance.githubUsersRepository = githubUsersRepository;
  }

  @InjectedFieldSignature("ru.gendalf13666.popularlibraries.baselogic.user.UserFragment.userAvatarRepository")
  public static void injectUserAvatarRepository(UserFragment instance,
